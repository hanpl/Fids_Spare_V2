            ...
            <div class="card card-info">
              ...
              <form class="form-horizontal" @submit.prevent="saveData">
                <div class="card-body">
                  ...
                  <div class="form-group row styleFromcontrol" >
                    <label for="inputPassword3" class="col-sm-4 col-form-label">Aircraft</label>
                    <div class="col-sm-8" style="display: flex;align-items: center;">
                      <input class="form-control classInput" type="text"
                      v-model="localFlightData.aircraft" >
                    </div>
                  </div>
                  <div class="form-group row styleFromcontrol" >
                    <label for="inputPassword3" class="col-sm-4 col-form-label">Config</label>
                    <div class="col-sm-8" style="display: flex;align-items: center;">
                      <input class="form-control classInput" type="text"
                      v-model="localFlightData.paxCount" >
                    </div>
                  </div>
                  <div class="form-group row styleFromcontrol" >
                    <label class="col-sm-4 col-form-label">Stand</label>
                    <div class="col-sm-8" style=" display: flex;align-items: center;">
                        <select class="form-control classInput" v-model="selectedStand">
                          <option>Stand14</option>
                          <option>Stand16</option>
                          <option>Stand18</option>
                          <option>Stand20</option>
                        </select>
                    </div>
                  </div>
                  <div class="form-group row styleFromcontrol" >
                    <label for="inputPassword3" class="col-sm-4 col-form-label">CodeShares</label>
                    <div class="col-sm-8" style="display: flex;align-items: center;">
                      <input class="form-control classInput" type="text"
                      v-model="localFlightData.codeShares" >
                    </div>
                  </div>
...
const selectedStand = ref(props.flightData.dailyUpdateStand); 
...
watch(() => props.flightData, (newVal) => {
    ...
    selectedStand.value = props.flightData.dailyUpdateStand;
...
function saveData() {
  ...
  localFlightData.dailyairline = selectedStand.value;
